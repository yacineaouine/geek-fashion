...
<body>
	...
	<h6 style="text-align: center">Veuillez vous authentifier pour
		accéder à votre compte d'administrateur</h6>
	<div class="card">
		<form method="post" action="login">
			<label for='txtLogin'>Votre Login :</label> <input id='txtLogin'
		...
		<p id="nav">
			...
			| <a href="https://yacineaouine.github.io/">Mot de passe
				oublié&nbsp;?</a>
		</p>
		<p id="backtoblog">
			<a href="./"> ← Retour vers Geek&Fashion </a>
		</p>
	</div>
